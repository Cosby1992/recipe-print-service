...
export class Config {
  ...
  @Min(1, {
    message: 'The environment variable API_PORT must be a positive number greater than 0.',
  })
  port: number;

  @IsNotEmpty({
    message: 'The environment variable NODE_ENV is required and cannot be empty.',
  })
  ...
  @IsNotEmpty({
    message: 'The environment variable OPENAI_API_KEY is required and cannot be empty.',
  })
  openaiApiKey: string;
}
